...
JavaClass AndroidUtil::Class_ZLibrary("com/koolearn/klibrary/core/library/ZLibrary");
JavaClass AndroidUtil::Class_ZLFile("com/koolearn/klibrary/core/filesystem/ZLFile");
JavaClass AndroidUtil::Class_FileInfo("com/koolearn/klibrary/core/fonts/FileInfo");
JavaClass AndroidUtil::Class_FileEncryptionInfo("com/koolearn/klibrary/core/drm/FileEncryptionInfo");
JavaClass AndroidUtil::Class_ZLFileImage("com/koolearn/klibrary/core/image/ZLFileImage");
JavaClass AndroidUtil::Class_ZLTextModel("com/koolearn/klibrary/text/model/ZLTextModel");

JavaClass AndroidUtil::Class_Encoding("com/koolearn/klibrary/core/encodings/Encoding");
JavaClass AndroidUtil::Class_EncodingConverter("com/koolearn/klibrary/core/encodings/EncodingConverter");
JavaClass AndroidUtil::Class_JavaEncodingCollection("com/koolearn/klibrary/core/encodings/JavaEncodingCollection");

JavaClass AndroidUtil::Class_NativeFormatPlugin("com/koolearn/kooreader/formats/NativeFormatPlugin");
JavaClass AndroidUtil::Class_PluginCollection("com/koolearn/kooreader/formats/PluginCollection");
JavaClass AndroidUtil::Class_Paths("com/koolearn/kooreader/Paths");
JavaClass AndroidUtil::Class_AbstractBook("com/koolearn/kooreader/book/AbstractBook");
JavaClass AndroidUtil::Class_Book("com/koolearn/kooreader/book/Book");
JavaClass AndroidUtil::Class_Tag("com/koolearn/kooreader/book/Tag");
JavaClass AndroidUtil::Class_BookModel("com/koolearn/kooreader/bookmodel/BookModel");
...
bool AndroidUtil::init(JavaVM* jvm) {
	...
	StaticMethod_NativeFormatPlugin_create = new StaticObjectMethod(Class_NativeFormatPlugin, "create", Class_NativeFormatPlugin, "(Lcom/koolearn/klibrary/core/util/SystemInfo;Ljava/lang/String;)");
	...
	Constructor_FileInfo = new Constructor(Class_FileInfo, "(Ljava/lang/String;Lcom/koolearn/klibrary/core/drm/FileEncryptionInfo;)V");
	...
	Constructor_ZLFileImage = new Constructor(Class_ZLFileImage, "(Lcom/koolearn/klibrary/core/filesystem/ZLFile;Ljava/lang/String;[I[ILcom/koolearn/klibrary/core/drm/FileEncryptionInfo;)V");
	...
	Method_Book_addTag = new VoidMethod(Class_AbstractBook, "addTag", "(Lcom/koolearn/kooreader/book/Tag;)");
	Method_Book_addUid = new VoidMethod(Class_AbstractBook, "addUid", "(Ljava/lang/String;Ljava/lang/String;)");

	StaticMethod_Tag_getTag = new StaticObjectMethod(Class_Tag, "getTag", Class_Tag, "(Lcom/koolearn/kooreader/book/Tag;Ljava/lang/String;)");
	...
	Method_BookModel_setBookTextModel = new VoidMethod(Class_BookModel, "setBookTextModel", "(Lcom/koolearn/klibrary/text/model/ZLTextModel;)");
	Method_BookModel_setFootnoteModel = new VoidMethod(Class_BookModel, "setFootnoteModel", "(Lcom/koolearn/klibrary/text/model/ZLTextModel;)");
	Method_BookModel_addImage = new VoidMethod(Class_BookModel, "addImage", "(Ljava/lang/String;Lcom/koolearn/klibrary/core/image/ZLImage;)");
	Method_BookModel_registerFontFamilyList = new VoidMethod(Class_BookModel, "registerFontFamilyList", "([Ljava/lang/String;)");
	Method_BookModel_registerFontEntry = new VoidMethod(Class_BookModel, "registerFontEntry", "(Ljava/lang/String;Lcom/koolearn/klibrary/core/fonts/FileInfo;Lcom/koolearn/klibrary/core/fonts/FileInfo;Lcom/koolearn/klibrary/core/fonts/FileInfo;Lcom/koolearn/klibrary/core/fonts/FileInfo;)");
