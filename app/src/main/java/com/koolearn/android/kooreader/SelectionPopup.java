...
class SelectionPopup extends PopupPanel implements View.OnClickListener {
	...
	SelectionPopup(KooReaderApp kooReader) {
		super(kooReader);
	}
	...
	public void createControlPanel(KooReader activity, RelativeLayout root) {
		...
		activity.getLayoutInflater().inflate(com.koolearn.klibrary.ui.android.R.layout.selection_panel, root);
		myWindow = (SimplePopupWindow)root.findViewById(com.koolearn.klibrary.ui.android.R.id.selection_panel);
