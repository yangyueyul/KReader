...
public class StringPreference extends DialogPreference {
	...
	protected StringPreference(Context context, ZLStringOption option, Constraint constraint, ZLResource rootResource, String resourceKey) {
		...
		setDialogLayoutResource(com.koolearn.klibrary.ui.android.R.layout.string_preference_dialog);
	...
	protected void onBindDialogView(View view) {
		myEditor = (EditText)view.findViewById(com.koolearn.klibrary.ui.android.R.id.string_preference_editor);
		myEditor.setText(myOption.getValue());
		((TextView)view.findViewById(com.koolearn.klibrary.ui.android.R.id.string_preference_hint)).setText(
