...
//
//	// Let's avoid using 'new' as much as possible. Meaning we introduce arrays 减少new
...
//
//	private Array<ShadowVertex> mArrDropShadowVertices; // 卷曲效果
...
//
//	// Bounding rectangle for this mesh.  4个翻页角
//	// mRectangle[0] = top-left corner
//	// mRectangle[1] = bottom-left
//	// mRectangle[2] = top-right
//	// mRectangle[3] = bottom-right
...
//			ByteBuffer hvbb = ByteBuffer.allocateDirect(mCurlPositionLinesCount * 2 * 2 * 4);
